...
session_start();
	...
	if($_SERVER['REQUEST_METHOD'] == "POST")
	{
		...
		if(!empty($score))//we dont want UN to be a No
		{
			...
			echo $score;
			echo $username;
			$query1 = "UPDATE  users SET cat2_score = '$score'  WHERE user_name = '$username'";
  ...
  <button class="btn btn-outline-light my-2 my-sm-0" type="submit">Search</button>
    ...
    <div id='container' class="container-fluid row mx-auto justify-content-center">
        <div class="col-sm-11 col-md-10 col-lg-6">
            <div id='title'>
                <h1 class="quiz-title">Data Structures Quiz</h1>
            </div>
            <br />
            <div id='quiz'></div>
    ...
    <script type='text/javascript' src="cat2.js"></script>
