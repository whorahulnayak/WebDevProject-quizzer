	...
	var questions = [
		...
		},
		{
			...
			choices: [
				...
				'X is binomial with mean 9 and variance 2.'
			],
			correctAnswer: 1
		},
		{
			question:
				'X is a random normal variable, with mean μ and variance σ2. The “standardised form” of X is Z = X−μ σ . What are the mean and variance, respectively, of Z ?',
			choices: [ '0,1', '2,1', '1,0', '2,0', '6/9' ],
			correctAnswer: 0
		},
		{
			question:
				'Nidhi has a bag filled with 4 caramels, two chocolates and three jellies. She put her hand in the bag and took out one sweet. What is the probability of getting a jelly?',
